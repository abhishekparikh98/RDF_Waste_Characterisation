...
The 60-to-6 TACO category mapping is documented inline in the preprocessing scripts under `src/` (see `data/yolo/data.yaml` for the 6-class names used during training).
